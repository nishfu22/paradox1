...
💠 Paradox music project was founded on March 23, 2021, we created a music bot project for streaming on telegram voice chat, which is now known as veez music bot.\n
🧪 Paradox music version:
❍ ver.6.5
❍ beta-version \n
👩🏻‍💻 developer:
❍ @{DEV_NAME}
